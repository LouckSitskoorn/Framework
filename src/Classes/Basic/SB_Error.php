<?php
  ...
  //USES
  use SB\Classes\Database\SB_Connection;
  ...
  class SB_Error {
    ...
    public function error_handler($errno=false, $errstr=false, $errfile=false, $errline=false, $errcontext=false, $errinfo=false) {
      global $_SESSION;
    ...
    public function error_logger($errno, $errstr, $errinfo, $errfile, $errline, $errcallerinfo) {
      if($errno == 0) return;
    ...
    public function error_filer($errno, $errstr, $errinfo, $errfile, $errline, $errcallerinfo) {
      if($errno == 0) return;
    ...
    public function error_mailer($errno, $errstr, $errinfo, $errfile, $errline, $errcallerinfo) {
      if($errno == 0) return;
    ...
    public function error_displayer($errno, $errstr, $errinfo, $errfile, $errline, $errcallerinfo) {
      if($errno == 0) return;
    ...
    */
    ...
    public function error_logtypeid($errno) {
      $returnvalue= "Unknown error";
    ...
    */
     ...
     */
    public static function error_php_syntax($code){
